...
According to \cite{murata1989},  a Petri net is defined as a tuple $N = (P, T, F, M_0)$, where $P$ is a finite set of places, $T$ is a finite set of transitions, and $F$ represents the flow relation, 
...
data structure used to represent Boolean functions \cite{bryant1986}. A Boolean 
